...
export const NavItem = ({ icon: Icon, title, path }) => {
  return (
    ...
    >
      {({ isActive }) => (
        <div className={`relative transition ease-in-out duration-500 flex items-center gap-[8px] tablet:w-[150px] rounded-[5px] p-[10px] cursor-pointer hover:bg-primary hover:tablet:w-[150px] hover:rounded-[5px] group ${isActive ? 'text-primary' : ''}`}>
